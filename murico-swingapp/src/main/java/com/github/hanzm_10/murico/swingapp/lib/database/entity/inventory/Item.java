...
public record Item(int _itemId, Timestamp itemCreatedAt, String itemName, int itemMinQuantity, float itemSRP,
		float itemWSP, int itemCategoryId, int itemPackTypeId) {
