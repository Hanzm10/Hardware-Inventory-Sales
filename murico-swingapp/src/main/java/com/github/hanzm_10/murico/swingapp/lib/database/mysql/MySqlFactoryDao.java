...
public final class MySqlFactoryDao extends AbstractSqlFactoryDao {
    ...
    static {
        ...
        try {
            ...
            // This might happen if a required property key is missing
             LOGGER.log(Level.SEVERE, "A required database property (URL, User, Password, Name) is missing in 'config.properties'", e);
     ...
     * @throws SQLTimeoutException If the driver has determined that the timeout value has been exceeded.
     ...
     * Checks for null and if the connection is already closed.
