...
// No direct AssetManager import needed here if icon comes from renderer
...
public class ButtonEditor extends AbstractCellEditor implements TableCellEditor, ActionListener {
    ...
    public ButtonEditor(InventoryScene parentScene, TableCellRenderer renderer) {
        ...
        this.ellipsisButton.addActionListener(e -> {
            // This ensures that the cell editing is stopped *before* the popup menu logic fires.
    ...
    private void showActionPopupMenu(Component invoker) {
        ...
        // Example: deleteItem.setIcon(AssetManager.getOrLoadIcon("/icons/delete_icon.svg", 16, 16));
        ...
        if (currentTableRef != null) {
             java.awt.Rectangle cellRect = currentTableRef.getCellRect(currentRowInTable, currentTableRef.convertColumnIndexToView(InventoryScene.COL_ACTION), false);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // Convert modelRow back to viewRow IF the methods in InventoryScene expect viewRow
        // However, it's often more robust to pass modelRow to InventoryScene and let IT handle
        // conversions if it needs to interact with view-specific aspects.
        // For now, assuming methods in InventoryScene can take modelRow or handle conversion.
